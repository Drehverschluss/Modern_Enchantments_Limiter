...
public final class ModConfig {
    ...
    public static final ModConfigSpec.IntValue BASE_LIMIT = BUILDER
    ...
    public static final ModConfigSpec.ConfigValue<String> TOOLTIP_COLOR = BUILDER
            .comment(
    ...
    public static final ModConfigSpec.BooleanValue APPLY_TO_ENCHANTED_BOOKS = BUILDER
            .comment("Whether the limit applies to enchanted books.")
            .define("applyToEnchantedBooks", true);

    public static final ModConfigSpec.BooleanValue APPLY_TO_DAMAGEABLE_ITEMS = BUILDER
            .comment("Whether the limit applies to items with durability (tools, weapons, armor).")
            .define("applyToDamageableItems", true);

    public static final ModConfigSpec.BooleanValue APPLY_TO_ALL_ENCHANTABLE_ITEMS = BUILDER
    ...
    public static final ModConfigSpec.IntValue MIN_LIMIT = BUILDER
            .comment("The resolved limit is never allowed to go below this value.")
            .defineInRange("minLimit", 0, 0, 256);

    public static final ModConfigSpec.IntValue MAX_LIMIT = BUILDER
            .comment("The resolved limit is never allowed to go above this value.")
            .defineInRange("maxLimit", 64, 1, 256);

    public static final ModConfigSpec.ConfigValue<List<? extends String>> TAG_OVERRIDES = BUILDER
            .comment(
    ...
    /** Set once by the mod constructor; used by the {@code /modernenchantmentslimiter reload} command. */
    public static net.neoforged.fml.config.ModConfig FML_CONFIG;
